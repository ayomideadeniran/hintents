...
describe('ProtocolHandler', () => {
    ...
    describe('rate limiting', () => {
        it('should allow requests within the defined rate limit', async () => {
            const uri1 =
                'erst://debug/a1b2c3d4e5f67890123456789abcdef0123456789abcdef0123456789abcdeff?network=testnet&source=dashboard';
            const uri2 =
                'erst://debug/b2c3d4e5f67890123456789abcdef0123456789abcdef0123456789abcdeffaa?network=testnet&source=dashboard';
